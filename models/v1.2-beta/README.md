# nathwaniGPT v1.2-beta

**Released:** 2026-08-22  
**Status:** Beta — testing improved reasoning quality

## What Changed from v1

### Parameters

| Parameter | v1 | v1.2-beta | Reason |
|---|---|---|---|
...
```bash
ollama create nathwaniGPT:beta -f models/v1.2-beta/Modelfile
ollama run nathwaniGPT:beta
```

## Feedback

If this version feels worse on any task type compared to v1, note it here before promoting to stable.
